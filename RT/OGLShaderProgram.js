...
FABRIC.define(["RT/Math", "RT/OGLBuffer"], function() {
...
FABRIC.appendOnCreateContextCallback(function(context) {
  context.RegisteredTypesManager.registerType('OGLShaderProgram', {
    members: {
      ...
      disableOptions: 'Integer[]',
      enableOptions: 'Integer[]',
      cullFace: 'Integer',
      blendModeSfactor: 'Integer',
      blendModeDfactor: 'Integer',
      drawMode: 'Integer',
    ...
    klBindings: {
      filename: 'OGLShaderProgram.kl',
      sourceCode: FABRIC.loadResourceURL('FABRIC_ROOT/RT/OGLShaderProgram.kl')
    }
  });
});
