...
FABRIC.define(["RT/Math", "RT/Mat33"], function() {
...
FABRIC.appendOnCreateContextCallback(function(context) {
  context.RegisteredTypesManager.registerType('RotationOrder', {
    ...
    klBindings: {
      ...
      sourceCode: FABRIC.loadResourceURL('FABRIC_ROOT/RT/RotationOrder.kl')
    }
  });
});
...
FABRIC.appendOnCreateContextCallback(function(context) {
  context.RegisteredTypesManager.registerType('Euler', {
    ...
    klBindings: {
      filename: 'Euler.kl',
      sourceCode: FABRIC.loadResourceURL('FABRIC_ROOT/RT/Euler.kl')
    }
  });
});
