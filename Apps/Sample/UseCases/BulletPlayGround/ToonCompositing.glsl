...
void main()
{
  ...
  vec3 depthEdge = 100.0 * sqrt((depthHorizEdge.rgb * depthHorizEdge.rgb) + (depthVertEdge.rgb * depthVertEdge.rgb));
  ...
  //gl_FragColor = texture2D( u_colorImage, gl_TexCoord[0].st );
}
