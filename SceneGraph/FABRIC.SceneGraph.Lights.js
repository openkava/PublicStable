    ...
    if (options.display === true) {
      ...
      scene.pub.constructNode('Instance', {
        transformNode: scene.pub.constructNode('Transform', {
          ...
          localXfo: FABRIC.RT.xfo({ ori: FABRIC.RT.Quat.makeFromAxisAndAngle(FABRIC.RT.Vec3.xAxis, Math.degToRad(90)) })
        }),
        geometryNode: circleNode,
        materialNode: materialNode
      });
      ...
      scene.pub.constructNode('Instance', {
        transformNode: scene.pub.constructNode('Transform', {
          hierarchical: true,
          parentTransformNode: pointLightNode.pub.getTransformNode(),
          localXfo: FABRIC.RT.xfo({ ori: FABRIC.RT.Quat.makeFromAxisAndAngle(FABRIC.RT.Vec3.zAxis, Math.degToRad(90)) })
        }),
        geometryNode: circleNode,
        materialNode: materialNode
      });
    ...
    if (options.display === true) {
      ...
      scene.pub.constructNode('Instance', {
        transformNode: scene.pub.constructNode('Transform', {
          hierarchical: true,
          parentTransformNode: directionalLightNode.pub.getTransformNode(),
          localXfo: FABRIC.RT.xfo({ ori: FABRIC.RT.Quat.makeFromAxisAndAngle(FABRIC.RT.Vec3.xAxis, Math.degToRad(90)), tr: FABRIC.RT.vec3(0, 0, -options.displaySize) })
        }),
        geometryNode: circleNode,
        materialNode: materialNode
      });
      ...
      scene.pub.constructNode('Instance', {
        transformNode: scene.pub.constructNode('Transform', {
          hierarchical: true,
          parentTransformNode: directionalLightNode.pub.getTransformNode(),
          localXfo: FABRIC.RT.xfo({ ori: FABRIC.RT.Quat.makeFromAxisAndAngle(FABRIC.RT.Vec3.xAxis, Math.degToRad(90)), tr: FABRIC.RT.vec3(0, 0, -options.displaySize*0.8) })
        }),
        geometryNode: circleNode,
        materialNode: materialNode
      });
      ...
      scene.pub.constructNode('Instance', {
        transformNode: scene.pub.constructNode('Transform', {
          ...
          localXfo: FABRIC.RT.xfo({
            ori: FABRIC.RT.Quat.makeFromAxisAndAngle(FABRIC.RT.Vec3.xAxis, Math.degToRad(90)),
