...
namespace Fabric
{
  namespace JSON
  {
        ...
        case '9':
        {
          ...
          else
          {
            ...
            else
            {
              ...
              entity.value.scalar = mantissa * pow( 10, exponent );
            }
          }
        }
        break;
    ...
    bool Entity::stringIs_Long( char const *data, size_t length ) const
    {
    ...
    void Entity::stringGetData_Long( char *data ) const
    {
