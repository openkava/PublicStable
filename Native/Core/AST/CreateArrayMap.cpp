...
namespace Fabric
{
  namespace AST
  {
    ...
    void CreateArrayMap::appendJSONMembers( Util::JSONObjectGenerator const &jsonObjectGenerator, bool includeLocation ) const
    {
    ...
    RC::ConstHandle<CG::Adapter> CreateArrayMap::getType( CG::BasicBlockBuilder &basicBlockBuilder ) const
    {
